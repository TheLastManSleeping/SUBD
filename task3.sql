...
insert into temp_university values ('Барановичский государственный университет'),
...
('Учреждение образования” Институт предпринимательской деятельности“ (ИПД)'),
...
insert into university(university) select name from temp_university order by name;